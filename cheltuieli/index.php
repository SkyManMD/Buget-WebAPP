...
<body onload='selectedItem("select_all_data.php")'>
	<div class='content'>
		<div class='menu'>
			<ul>
				<li><button onclick='home()'>PRINCIPALĂ</button></li> <p style='display:inline; font-size:29px; color:#de0000'>|</p>
				...
				<li><button onclick='selectedItem("insert_form.php"), selectedButon(3)'>ADAUGĂ CHELTUIELI</button></li>
			</ul>
			<br/><hr/>
		</div>
		<div class='ajax_body'>
