<html> 
<head>
		<title>Adaugare Categorie : Venit</title>
...
<?php
	...
	$nume_categ = mysql_real_escape_string($_GET['nume_categ_venit']);
	if(strlen($nume_categ)>3)
	$insert = mysql_query("INSERT INTO categorii_venituri(id_cat_venit,nume_categ) 
